...
" Vim session script.
" Created by session.vim 2.13.1 on 04 février 2016 at 15:35:59.
...
badd +0 ~/Homestead7/composer.json
...
exe 'vert 1resize ' . ((&columns * 66 + 79) / 159)
exe 'vert 2resize ' . ((&columns * 92 + 79) / 159)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
